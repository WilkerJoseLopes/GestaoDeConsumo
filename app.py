...
spreadsheet = client.open("Gestão consumos de água, energia e gás")  
casas_sheet = spreadsheet.worksheet("Dados Casa")
consumos_sheet = spreadsheet.worksheet("Dados Consumos")
